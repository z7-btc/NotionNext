      ...
      if (sourceUrl) {
        ...
        if (sourceUrl.startsWith('attachment:')) {
          ...
          if (fileName?.endsWith('.mp4')) {
            console.log('Processing video file in filterPostBlocks:', fileName)
            const spaceId = '17b0a3b0-9813-479b-97d8-912500276264'
            const baseUrl = `https://file.notion.so/f/f/${spaceId}/${fileId}/${fileName}`
            ...
            console.log('Generated video URL in filterPostBlocks:', newUrl)
