...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 10, // 更新缓存间隔 单位(秒)；10秒后访问会触发重新生成，平衡性能和实时性
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'TraderDonMark', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '交易员，程序员，Businessman🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.tradenow.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客交易, 加密货币, 量化, 投资,', // 网站关键词 英文逗号隔开
